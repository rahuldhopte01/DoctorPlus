                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 d-none d-md-block bg-light position-relative">
                        <div class="position-absolute top-50 start-50 translate-middle w-100 p-5 text-center z-index-2">
                            <h2 class="display-6 fw-bold mb-4" style="color: var(--primary-color);">Verwalten Sie Labortests sicher.</h2>
                    ...
                    <div class="col-md-6 p-4 p-lg-5">
                        <div class="mb-5">
                            <h2 class="fw-bold fs-3 text-dark mb-1">Labor-Portal</h2>
                            <h3 class="fw-medium text-muted fs-5">Melden Sie sich an, um Testanfragen zu verwalten.</h3>
                        </div>
                        ...
                        <form method="POST" action="{{ url('verify_pathologist') }}" class="needs-validation" novalidate="">
                            ...
                            <div class="text-center mt-4 border-top pt-4">
                                <p class="text-muted small mb-3">Noch kein Konto? <a href="{{url('pathologist_sign_up')}}" class="text-primary text-decoration-none fw-semibold ms-1">Hier registrieren</a></p>
