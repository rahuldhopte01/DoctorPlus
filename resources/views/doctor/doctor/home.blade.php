                                        ...
                                        <td>
                                            ...
                                            @elseif($appointment->appointment_status == 'pending' || $appointment->appointment_status == 'canceled' || $appointment->appointment_status == 'cancel')
                                                @if($appointment->questionnaire_id)
                                                    <a href="{{ route('doctor.questionnaire.review', $appointment->id) }}" class="btn btn-sm bg-warning-light mr-1" title="{{__('View Questionnaire')}}">
                                                        <i class="fas fa-clipboard-list"></i>
                                                        @if($appointment->flaggedAnswers()->count() > 0)
                                                            <span class="badge badge-danger badge-sm">{{ $appointment->flaggedAnswers()->count() }}</span>
                                                        @endif
                                                    </a>
                                                @endif
