...
@section('title', __('Edit Sub-Doctor'))
@section('content')

<section class="section">
    @include('layout.breadcrumb',[
        'title' => __('Edit Sub-Doctor'),
    ...
    <div class="section_body">
        <form action="{{ route('clinic.doctors.update', $doctor->id) }}" method="post" enctype="multipart/form-data" class="myform">
            @csrf
            @method('PUT')
            ...
            <div class="alert alert-info mb-4">
                ...
                {{ __('Editing sub-doctor for clinic:') }} <strong>{{ $clinic->name ?? 'N/A' }}</strong>
            </div>
                ...
                <div class="card-body">
                    <div class="row mt-4">
                        <div class="col-lg-2 col-md-4">
                            ...
                            <div class="avatar-upload avatar-box avatar-box-left">
                                ...
                                <div class="avatar-preview">
                                    <div id="imagePreview" style="background-image: url('{{ $doctor->fullImage }}');"></div>
                                </div>
                            </div>
                            @error('image')
                        ...
                        <div class="col-lg-10 col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ old('name', $doctor->name) }}" class="form-control @error('name') is-invalid @enderror">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" value="{{ $doctor->user['email'] ?? '' }}" class="form-control" disabled>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6 form-group">
                            ...
                            <div class="d-flex @error('phone') is-invalid @enderror">
                                <select name="phone_code" class="phone_code_select2" value="{{ old('phone_code', $doctor->user['phone_code'] ?? '') }}">
                                    @foreach ($countries as $country)
                                        <option value="+{{ $country->phonecode }}" {{ (old('phone_code', $doctor->user['phone_code'] ?? '') == '+' . $country->phonecode) ? 'selected' : '' }}>+{{ $country->phonecode }}</option>
                                    @endforeach
                                </select>
                                <input type="number" min="1" name="phone" class="form-control" value="{{ old('phone', $doctor->user['phone'] ?? '') }}">
                            </div>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" class="form-control datePicker @error('dob') is-invalid @enderror" value="{{ old('dob', $doctor->dob) }}" name="dob">
                            @error('dob')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12 form-group">
                            ...
                            <textarea name="desc" rows="5" class="form-control @error('desc') is-invalid @enderror">{{ old('desc', $doctor->desc) }}</textarea>
                            @error('desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="education-info">
                            @php
                                $educations = json_decode($doctor->education, true) ?? [['degree' => '', 'college' => '', 'year' => '']];
                            @endphp
                                        ...
                                        <div class="row form-row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" maxlength="4" pattern="^[0-9]{4}$" name="year[]" value="{{ $education['year'] ?? '' }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <div class="awards-info">
                                @php
                                    $certificates = json_decode($doctor->certificate, true) ?? [['certificate' => '', 'certificate_year' => '']];
                                @endphp
                                    ...
                                    <div class="row form-row awards-cont">
                                        <div class="col-12 col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="certificate[]" value="{{ $cert['certificate'] ?? '' }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-5">
                                            <div class="form-group">
                                                <label>{{ __('Year') }}</label>
                                                <input type="text" name="certificate_year[]" maxlength="4" value="{{ $cert['certificate_year'] ?? '' }}" pattern="^[0-9]{4}$" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6 form-group">
                            ...
                            <select name="timeslot" class="form-control @error('timeslot') is-invalid @enderror">
                                ...
                                <option value="other" {{ !in_array($doctor->timeslot, [15, 30, 45, 60, 90]) ? 'selected' : '' }}>{{ __('Other') }}</option>
                            </select>
                            @error('timeslot')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6 form-group custom_timeslot {{ !in_array($doctor->timeslot, [15, 30, 45, 60, 90]) ? '' : 'hide' }}">
                            <label class="col-form-label">{{ __('Add timeslot value(In minutes)') }}</label>
                            <input type="number" min="1" value="{{ $doctor->custom_timeslot }}" name="custom_time" class="form-control custom_timeslot_text @error('timeslot') is-invalid @enderror">
                            @error('timeslot')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 form-group base_on_com {{ $doctor->based_on == 'commission' ? '' : 'hide' }}">
                            ...
                            <input type="number" min="1" step="any" value="{{ $doctor->commission_amount }}" name="commission_amount" class="form-control base_on_com_text @error('commission') is-invalid @enderror">
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-6 form-group">
                            ...
                            <input class="form-control timepicker @error('start_time') is-invalid @enderror" name="start_time" value="{{ old('start_time', $doctor->start_time) }}" type="time">
                            @error('start_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-lg-6 form-group">
                            ...
                            <input class="form-control timepicker @error('end_time') is-invalid @enderror" name="end_time" value="{{ old('end_time', $doctor->end_time) }}" type="time">
                            @error('end_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('Leave empty to keep the same password') }}">
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
