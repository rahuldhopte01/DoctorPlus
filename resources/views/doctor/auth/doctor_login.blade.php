                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 d-none d-md-block bg-light position-relative">
                        <div class="position-absolute top-50 start-50 translate-middle w-100 p-5 text-center z-index-2">
                            <h2 class="display-6 fw-bold mb-4" style="color: var(--primary-color);">Verwalten Sie Ihre Klinik effizient.</h2>
                    ...
                    <div class="col-md-6 p-4 p-lg-5">
                        <div class="mb-5">
                            ...
                            <h3 class="fw-medium text-muted fs-5">Melden Sie sich an!</h3>
                        </div>
                        ...
                        <form action="{{ url('doctor/verify_doctor') }}" method="post" class="needs-validation" novalidate="">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <a href="{{url('doctor_forgot_password')}}" class="text-decoration-none small text-muted hover-primary transition-all">Passwort vergessen?</a>
                            </div>
                            ...
                            <div class="text-center mt-4 border-top pt-4">
                                <p class="text-muted small mb-3">Noch kein Konto? <a href="{{url('doctor/doctor_signup')}}" class="text-primary text-decoration-none fw-semibold ms-1">Hier registrieren</a></p>
