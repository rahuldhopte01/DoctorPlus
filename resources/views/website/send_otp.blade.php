            ...
            <div class="card border-0 shadow-bloomwell rounded-4 overflow-hidden">
                <div class="row g-0">
                    ...
                    <div class="col-md-12 col-lg-7 p-4 p-lg-5">
                        ...
                        <form action="{{ url('verify_user') }}" method="post" id="otpForm">
                            @csrf
                            ...
                            <div class="mt-4 text-center">
                                <p class="text-muted small">
                                    ...
                                    <a href="{{ url('send_otp') }}" class="text-primary text-decoration-none fw-semibold ms-1 transition-all hover-primary">
                                        {{__('Resend Code')}}
                                    </a>
                                </p>
                            </div>
