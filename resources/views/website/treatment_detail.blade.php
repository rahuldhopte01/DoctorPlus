...
<nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top border-bottom">
    <div class="container">
        <a class="navbar-brand" href="{{ url('/') }}">
            ...
            @else
                <img src="{{ url('/images/upload_empty/logo_black.png') }}" alt="{{ $setting->business_name }}" height="40">
            @endif
        </a>
    ...
    <div class="container">
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6 col-lg-3">
                ...
                @else
                    <img src="{{ url('/images/upload_empty/logo_black.png') }}" alt="{{ $setting->business_name }}" height="40" class="mb-3" style="filter: brightness(0) invert(1);">
                @endif
