                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 p-4 p-lg-5">
                        <div class="mb-5">
                            ...
                            <h3 class="fw-medium text-muted fs-5">{{__('Login to get started!')}}</h3>
                        </div>
                        ...
                        <form action="{{ url('patient-login') }}" method="post">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <a href="{{url('/forgot_password')}}" class="text-decoration-none small text-muted hover-primary transition-all">{{__('Forgot Password?')}}</a>
                            </div>
                            ...
                            <div class="text-center mt-4 border-top pt-4">
                                <p class="text-muted small mb-3">{{__('Don’t have an account?')}} <a href="{{url('/signup')}}" class="text-primary text-decoration-none fw-semibold ms-1">{{__('Signup')}}</a></p>
                                
                                <div class="d-flex justify-content-center gap-2 flex-wrap mt-3">
                                   <a href="{{url('/doctor/doctor_login')}}" class="badge bg-light text-dark border p-2 text-decoration-none hover-primary transition-all"><i class="bi bi-stethoscope me-1"></i> {{__('Doctor Login')}}</a>
                                </div>
                            </div>
                        </form>
                    </div>
