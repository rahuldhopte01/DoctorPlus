                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-6 d-none d-md-block bg-light position-relative">
                        <div class="position-absolute top-50 start-50 translate-middle w-100 p-5 text-center z-index-2">
                            <h2 class="display-6 fw-bold mb-4" style="color: var(--primary-color);">Verwalten Sie Ihre Apotheke online.</h2>
                            <img src="{{asset('assets/image/login.png')}}" class="img-fluid custom-login-image" alt="Pharmacy Login Graphic" style="max-height: 250px; object-fit: contain;">
                        </div>
                    ...
                    <div class="col-md-6 p-4 p-lg-5">
                        <div class="mb-5">
                            <h2 class="fw-bold fs-3 text-dark mb-1">Apotheken-Portal</h2>
                            <h3 class="fw-medium text-muted fs-5">Melden Sie sich an, um Rezepte zu verwalten.</h3>
                        </div>
                        ...
                        @if (session('status'))
                        <div class="alert alert-info rounded-3 p-2 mb-4 d-flex align-items-center small" role="alert">
                            <i class="bi bi-info-circle-fill me-2"></i>
                            <div>{{ session('status') }}</div>
                        </div>
                        @endif

                        <form action="{{ url('verify_pharmacy') }}" method="post" class="needs-validation" novalidate="">
                            @csrf
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <a href="{{url('pharmacy_forgot_password')}}" class="text-decoration-none small text-muted hover-primary transition-all">Passwort vergessen?</a>
                            </div>
                            ...
                            <div class="text-center mt-4 border-top pt-4">
                                <p class="text-muted small mb-3">Noch kein Konto? <a href="{{url('pharmacy_signUp')}}" class="text-primary text-decoration-none fw-semibold ms-1">Hier registrieren</a></p>
                                
                                <div class="d-flex justify-content-center gap-2 flex-wrap mt-3">
                                   <a href="{{url('/patient-login')}}" class="badge bg-light text-dark border p-2 text-decoration-none hover-primary transition-all"><i class="bi bi-person me-1"></i> Patienten-Login</a>
                                </div>
                            </div>
                        </form>
                    </div>
