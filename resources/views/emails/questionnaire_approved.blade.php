...
<title>Fragebogen genehmigt – {{ $setting->business_name ?? 'dr.fuxx' }}</title>
</head>
  ...
  <tr>
    <td align="center">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;max-width:600px;box-shadow:0 10px 30px rgba(123,66,246,0.1);">
        ...
        <!-- Success Banner -->
        <tr>
          <td style="background-color:#f0fff4;padding:32px 48px;text-align:center;border-bottom:1px solid #c6f6d5;">
            <div style="display:inline-block;background-color:#ffffff;border:2px solid #38a169;border-radius:50%;width:72px;height:72px;line-height:72px;text-align:center;margin-bottom:16px;">
              <span style="font-size:32px;">✅</span>
            </div>
            <h1 style="color:#22543d;font-size:26px;font-weight:800;margin:0 0 8px;">Fragebogen genehmigt!</h1>
            <p style="color:#38a169;font-size:13px;margin:0;letter-spacing:1px;text-transform:uppercase;font-weight:700;">Ihre Anfrage wurde erfolgreich bestätigt</p>
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:40px 48px 32px;">
            ...
            <p style="color:#4a4a4a;font-size:15px;line-height:1.7;margin:0 0 32px;">
              Tolle Neuigkeiten! Dr. <strong style="color:#1a1a1a;">{{ $doctor_name }}</strong> hat Ihren Fragebogen geprüft und dieser wurde <strong style="color:#38a169;">genehmigt</strong>. @if(!empty($doctor_notes))Nachfolgend finden Sie die Anmerkungen des Arztes und die weiteren Schritte.@else Sie können Ihr Rezept und die weiteren Details nun in Ihrem Dashboard einsehen.@endif
            </p>
                  ...
                  <table cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                    <tr>
                      <td style="vertical-align:middle;padding-right:12px;">
                        <div style="width:40px;height:40px;background:#f3eeff;border:1px solid #7b42f6;border-radius:50%;line-height:40px;text-align:center;">
                          <span style="font-size:18px;">👨‍⚕️</span>
                        </div>
                      </td>
                      <td style="vertical-align:middle;">
                        <p style="color:#7b42f6;font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;margin:0 0 2px;">Anmerkungen des Arztes</p>
                        <p style="color:#6b7280;font-size:12px;margin:0;">Dr. {{ $doctor_name }} &nbsp;·&nbsp; {{ $review_date }}</p>
                      </td>
                    </tr>
                  </table>
                  <p style="color:#4a4a4a;font-size:14px;line-height:1.7;margin:0;font-style:italic;border-left:3px solid #7b42f6;padding-left:16px;">
                    "{{ $doctor_notes }}"
                  </p>
                </td>
              </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      ...
                      <td style="padding:8px 0;text-align:right;">
                        <span style="background-color:#c6f6d5;color:#22543d;font-size:11px;font-weight:700;padding:4px 12px;border-radius:20px;letter-spacing:1px;">GENEHMIGT</span>
                      </td>
                    </tr>
                  </table>
                </td>
        ...
        <tr>
          <td style="background-color:#f9fafb;padding:32px 48px;border-top:1px solid #e5e7eb;text-align:center;">
            <p style="color:#6b7280;font-size:12px;margin:0 0 8px;">Haben Sie Fragen? Kontaktieren Sie uns unter <a href="mailto:{{ $support_email }}" style="color:#7b42f6;text-decoration:none;font-weight:600;">{{ $support_email }}</a></p>
